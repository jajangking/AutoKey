...
interface BluetoothScannerProps {
  bleManager?: BleManager;           // Optional BleManager instance
  bleManagerRef?: React.RefObject<BleManager>; // Optional BleManager ref
  onDeviceSelect: (device: Device) => void;
  visible: boolean;
  onClose: () => void;
}

const HybridBluetoothScanner: React.FC<BluetoothScannerProps> = ({ 
  bleManager, 
  bleManagerRef, 
  onDeviceSelect, 
  visible, 
  ...
  const getBleManager = () => {
    ...
    throw new Error('Either bleManager or bleManagerRef must be provided');
  };
...
export default HybridBluetoothScanner;